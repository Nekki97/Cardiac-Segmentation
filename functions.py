...
def get_datasets(data, split_number):
    ...
    train_images = data[split_number].get("train_images")
    train_masks = data[split_number].get("train_masks")
    val_images = data[split_number].get("val_images")
    val_masks = data[split_number].get("val_masks")
    test_images = data[split_number].get("test_images")
    test_masks = data[split_number].get("test_masks")
